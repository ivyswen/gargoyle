...
?>
	...
	<fieldset>
		...
		<div id="printer_found_div">
			...
			<p><strong><span id="printer_id"></span> is connected via USB.</strong></p>
			
			<p>You can connect to your printer on IP <span id="router_ip"></span> via HP JetDirect protocol.</p>
		</div>
