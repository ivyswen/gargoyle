...
<form>
	<fieldset id="config_fieldset">
		<legend class="sectionheader">设备配置</legend>
		<label class='leftcolumn' style="text-decoration:underline">配置设备为:</label>
		<div class='indent'>
			<input type="radio" id="global_gateway" name="global_configuration" value="gateway" onclick="setBridgeVisibility()" />
			<label for="global_gateway">网关 (默认)</label>
			<br/>
			<input type="radio" id="global_bridge" name="global_configuration" value="bridge" onclick="setBridgeVisibility()" />
			<label for="global_bridge">无线桥接/中继</label>
		</div>
	</fieldset>

	<fieldset id="bridge_fieldset">
		<legend class="sectionheader">无线桥接/中继</legend>
		<div id='bridge_ip_container'>
			<label class='leftcolumn' for='bridge_ip' id='bridge_ip_label'>网桥 IP:</label>
		...
		<div id='bridge_mask_container'>
			<label class='leftcolumn' for='bridge_mask' id='bridge_mask_label'>子网掩码:</label>
		...
		<div id='bridge_gateway_container'>
			<label class='leftcolumn' for='bridge_gateway' id='bridge_gateway_label'>AP/网关 IP:</label>
		...
		<div id= "bridge_wan_port_to_lan_container">
			<label class='leftcolumn' for='bridge_wan_port_to_lan' id='bridge_wan_port_to_lan_label'>Wan以太网端口:</label>
			<select class='rightcolumn' id='bridge_wan_port_to_lan' onchange='setBridgeVisibility()'>
				<option value='disable'>禁用</option>
				<option value='bridge'>桥接至LAN</option>
			</select>
		</div>

		<div id="bridge_dns_source_container">
			<span class="leftcolumn">
				<label id='bridge_dns_source_label' for='bridge_dns_source'>DNS 服务器:</label>
			</span>
			<select class='rightcolumn' id="bridge_dns_source" onchange="setDnsSource(this)"> 
				<option value="gateway">使用网关作为DNS服务器</option>
				<option value="custom">使用自定义DNS服务器</option>
			</select>
		</div>
		<div id="bridge_dns_custom_container">
			<span class='rightcolumnonly'>
				...
				<input type="button" class="default_button" id="add_bridge_dns_button" value="添加" onclick='addDns("bridge")' />
			</span>
		...
		<div id='bridge_mode_container'>
			<select class='nocolumn' id='bridge_mode' onchange='setBridgeVisibility()'>
				<option value='client_bridge'>通过客户端网桥连接</option>
				<option value='wds'>通过WDS连接</option>
			</select>
		</div>
		<div class="indent">
			<div id='bridge_repeater_container'>
				<label class='leftcolumn' for='bridge_repeater' id='bridge_repeater_label'>中继:</label>
				<select class='rightcolumn' id='bridge_repeater' onchange='setBridgeVisibility()'>
					<option value='enabled'>开启中继</option>
					<option value='disabled'>关闭中继</option>
				</select>
			</div>

			<div id='bridge_hwmode_container'>
				<label class='leftcolumn' for='bridge_hwmode' id='bridge_hwmode_label'>模式:</label>
			...
			<div id='bridge_channel_width_container'>
				<label class='leftcolumn' for='bridge_channel_width' id='bridge_channel_width_label'>频宽:</label>
				<span class='rightcolumn'>
			...
			<div id='bridge_txpower_container'>
				<label class='leftcolumn' for='bridge_txpower_max' id='bridge_txpower_label'>发射功率:</label>
				<span class='rightcolumn'>
			...
			<div id='bridge_channel_width_5ghz_container'>
				<label class='leftcolumn' for='bridge_channel_width_5ghz' id='bridge_channel_width_5ghz_label'>频宽:</label>
				<span class='rightcolumn'>
			...
			<div id='bridge_txpower_5ghz_container'>
				<label class='leftcolumn' for='bridge_max_txpower_5ghz' id='bridge_txpower_5ghz_label'>发射功率:</label>
				<span class='rightcolumn'>
			...
			<div id='bridge_list_ssid_container'>
				<label class='leftcolumn' for='bridge_list_ssid' id='bridge_list_ssid_label'>SSID 加入:</label>
				<span class="rightcolumn">
					...
					<input type='button' class='default_button' id='bridge_rescan_button' value='再次搜索' onclick='scanWifi("bridge_custom_ssid")' />
				</span>
			</div>
			...
			<div id='bridge_ssid_container'>
				<label class='leftcolumn' for='bridge_ssid' id='bridge_ssid_label'>SSID 加入:</label>
				<span class='rightcolumn'>
					<input style="float:left;"  type='text' id='bridge_ssid'  size='20' onkeyup='proofreadLengthRange(this,1,999)'/>
					<input style="float:left;"  type='button' class='default_button' id='bridge_scan_button' value='搜索' onclick='scanWifi("bridge_ssid")' />
				</span>
			</div>
			<div id='bridge_broadcast_ssid_container'>
				<label class='leftcolumn' for='bridge_broadcast_ssid' id='bridge_broadcast_ssid_label'>SSID 广播:</label>
			...
			<div id='bridge_channel_container'>
				<label class='leftcolumn' for='bridge_channel' id='bridge_channel_label'>无线频道:</label>
			...
			<div id='bridge_channel_5ghz_container'>
				<label class='leftcolumn' for='bridge_channel_5ghz' id='bridge_channel_5ghz_label'>无线频道:</label>
				<select class='rightcolumn' id='bridge_channel_5ghz' onchange='setChannel(this)' ></select>
			</div>

			<div id='bridge_fixed_channel_container'>
				<label class='leftcolumn' for='bridge_fixed_channel' id='bridge_fixed_channel_label'>无线频道:</label>
				<span class='rightcolumn' id='bridge_fixed_channel'>&nbsp;</span>
			</div>

			<div id='bridge_encryption_container'>
				<label class='leftcolumn' for='bridge_encryption' id='bridge_encryption_label'>加密:</label>
			...
			<div id='bridge_fixed_encryption_container' >
				<label class='leftcolumn' for='bridge_fixed_encryption' id='bridge_fixed_encryption_label'>加密:</label>
				<span class='rightcolumn' id='bridge_fixed_encryption'>&nbsp;</span>
			</div>

			<div id='bridge_pass_container'>
				<label class='leftcolumn' for='bridge_pass' id='bridge_pass_label'>密码:</label>
				<input type='password' id='bridge_pass' size='20' onkeyup='proofreadLengthRange(this,8,999)'/><br/>
			</div>
			<div id='bridge_wep_container'>
				<div style="display:block;">
					<label class='leftcolumn' for='bridge_wep' id='bridge_wep_label' >WEP 密钥:</label>
					<input type='text' id='bridge_wep' size='30' maxLength='26' onkeyup='proofreadWep(this)'/>
				</div>
			</div>

			<div id='bridge_wifi_mac_container' >
				<label class='leftcolumn' id='bridge_wifi_mac_label'><em>这个</em> 设备的 MAC:</label>
				<span class='rightcolumn' id='bridge_wifi_mac'> </span>
			</div>
			<div id="bridge_wds_container" >
				<label class='leftcolumn' for='bridge_wds_label' id='bridge_wds_label'><em>其他</em> WDS MAC 地址:</label>
				<span class='rightcolumn'>
					<input type='text' id='add_bridge_wds_mac' onkeyup='proofreadMac(this)' size='20' maxlength='17' />
					<input type="button" class="default_button" id="add_bridge_wds_mac_button" value="添加" onclick='addMacToWds("bridge")' />
				</span>
	...
	<fieldset id="wan_fieldset">
		<legend class="sectionheader">因特网 / WAN</legend>

		<div id='wan_protocol_container'>
			<label class='leftcolumn' for='wan_protocol'>连接方式:</label>
		...
		<div id='wan_dhcp_ip_container'>
			<label class='leftcolumn'>当前 IP:</label>
			<span class='rightcolumn' id='dhcp_ip'></span>
		</div>
		<div id='wan_dhcp_expires_container'>
			<label class='leftcolumn'>当前租约期满后:</label>
			<span class='rightcolumn'>
				<span id="dhcp_expires"></span>
			</span>

			<div class='rightcolumnonly' style="margin-bottom:15px">
				<input type='button' id="dhcp_renew_button" value="立即续订租约" class="default_button" onclick="renewDhcpLease()" />
			</div>
		</div>

		<div id='wan_pppoe_user_container' >
			<label class='leftcolumn' for='wan_pppoe_user' id='wan_pppoe_user_label'>用户名:</label>
		...
		<div id='wan_pppoe_pass_container' >
			<label class='leftcolumn' for='wan_pppoe_pass' id='wan_pppoe_pass_label'>密码:</label>
		...
		<div id='wan_pppoe_reconnect_mode_container' >
			<label class='leftcolumn' for='wan_pppoe_reconnect_mode'>重连方式:</label>
			<select class='rightcolumn' id='wan_pppoe_reconnect_mode' onchange='setWanVisibility()'>
				<option value='demand'>按需连接</option>
				<option value='keepalive'>自动重连</option>
			</select>
		</div>
		<div id='wan_pppoe_max_idle_container' >
			<label class='leftcolumn' for='wan_pppoe_max_idle' id='wan_pppoe_max_idle_label'>最大空闲时间:</label>
		...
		<div id='wan_pppoe_reconnect_pings_container' >
			<label class='leftcolumn' for='wan_pppoe_reconnect_pings' id='wan_pppoe_reconnect_pings_label'>Ping 检查次数:</label>
			<div class='rightcolumn'>
		...
		<div id='wan_pppoe_interval_container' >
			<label class='leftcolumn' for='wan_pppoe_interval' id='wan_pppoe_interval_label'>Ping 间隔:</label>
			<div class='rightcolumn'>
		...
		<div id='wan_static_ip_container' >
			<label class='leftcolumn' for='wan_static_ip' id='wan_static_ip_label'>静态 IP:</label>
		...
		<div id='wan_static_mask_container' >
			<label class='leftcolumn' for='wan_static_mask' id='wan_static_mask_label'>子网掩码:</label>
		...
		<div id='wan_static_gateway_container' >
			<label class='leftcolumn' for='wan_static_gateway' id='wan_static_gateway_label'>网关:</label>
		...
		<div id='wan_3g_service_container'>
			<label class='leftcolumn' for='wan_3g_service'>3G服务:</label>
		...
		<div id='wan_3g_device_container' >
			<label class='leftcolumn' for='wan_3g_device' id='wan_3g_device_label'>3G设备:</label>
			<span class='rightcolumn'>
		...
		<div id='wan_3g_pincode_container' >
			<label class='leftcolumn' for='wan_3g_pincode' id='wan_3g_pincode_label'>3G Pincode:</label>
		...
		<div id='wan_3g_isp_container'>
			<label class='leftcolumn' for='wan_3g_isp'>3G ISP:</label>
		...
		<div id='wan_3g_user_container' >
			<label class='leftcolumn' for='wan_3g_user' id='wan_3g_user_label'>用户名:</label>
		...
		<div id='wan_3g_pass_container' >
			<label class='leftcolumn' for='wan_3g_pass' id='wan_3g_pass_label'>密码:</label>
		...
		<div id='wan_port_to_lan_container' >
			<label class='leftcolumn' for='wan_port_to_lan' id='wan_port_to_lan_label'>Wan以太网端口:</label>
		...
		<div id='wan_mac_container' >
			<span class='leftcolumn'>
				<label for='wan_mac' id='wan_mac_label'>使用自定义 MAC 地址:</label>
			</span>
			<span class="rightcolumn">
		...
		<div id='wan_mtu_container' >
			<span class='leftcolumn'>
				<label for='wan_mtu' id='wan_mtu_label'>使用自定义 MTU:</label>
			</span>
			<span class='rightcolumn'>
	...
	<fieldset id="lan_fieldset">
		<legend class="sectionheader">本地网络 / LAN</legend>

		<div id='lan_ip_container'>
			<label class='leftcolumn' for='lan_ip' id='lan_ip_label'>路由器 IP:</label>
		...
		<div id='lan_mask_container'>
			<label class='leftcolumn' for='lan_mask' id='lan_mask_label'>子网掩码:</label>
		...
		<div id='lan_gateway_container'>
			<label class='leftcolumn' for='lan_gateway' id='lan_gateway_label'>网关:</label>
		...
		<div id="lan_dns_source_container">
			<span class="leftcolumn">
				<label id='lan_dns_source_label' for='lan_dns_source'>DNS 服务器:</label>
			</span>
			<select class='rightcolumn' id="lan_dns_source" onchange="setDnsSource(this)"> 
				<option value="isp">默认由ISP指定的DNS服务器</option>
				<option value="opendns">OpenDNS 服务器</option>
				<option value="google">Google DNS 服务器</option>
				<option value="custom">自定义 DNS 服务器</option>
			</select>
		</div>
		<div id="lan_dns_custom_container">
			...
			<span class='rightcolumnonly'>
				...
				<input type="button" class="default_button" id="add_lan_dns_button" value="添加" onclick='addDns("lan")' />
			</span>
			<span style="clear:both"></span>
		...
		<div id="lan_dns_options_container">
			<span class='rightcolumnonly'>
				...
				<label for="lan_dns_altroot" id="lan_dns_altroot_label" style="vertical-align:middle">&nbsp;&nbsp;允许 <a href="http://www.dot-bit.org">NameCoin</a>/<a href="http://www.opennicproject.org">OpenNIC</a> 解析</label>

			</span>
			<span style="clear:both;"></span>
			<span class='rightcolumnonly'>
				<input type='checkbox' id='lan_dns_force' style="padding:0;margin:0px;vertical-align:middle;overflow:hidden;"/>
				<label for="lan_dns_force" id="lan_dns_force_label" style="vertical-align:middle">&nbsp;&nbsp;强制客户端使用路由器的DNS服务器</span>
			</span>
		</div>
	...
	<fieldset id="wifi_fieldset">
		...
		<legend class="sectionheader">无线</legend>

		<div id='wifi_mode_container'>
			<label class='leftcolumn' for='wifi_mode' id='wifi_mode_label'>无线模式:</label>
		...
		<div id='wifi_hwmode_container'>
			<label class='leftcolumn' for='wifi_hwmode' id='wifi_hwmode_label'>模式:</label>
			<span class='rightcolumn'>
		...
		<div id='wifi_channel_width_container' >
			<label class='leftcolumn' for='wifi_channel_width' id='wifi_channel_width_label'>频宽:</label>
			<span class='rightcolumn'>
		...
		<div id='wifi_txpower_container' >
			<label class='leftcolumn' for='wifi_max_txpower' id='wifi_txpower_label'>发送功率:</label>
			<span class='rightcolumn'>
		...
		<div id='wifi_channel_width_5ghz_container'>
			<label class='leftcolumn' for='wifi_channel_width_5ghz' id='wifi_channel_width_5ghz_label'>5GHz 频宽:</label>
			<span class='rightcolumn'>
		...
		<div id='wifi_txpower_5ghz_container'>
			<label class='leftcolumn' for='wifi_max_txpower_5ghz' id='wifi_txpower_5ghz_label'>5GHz 发送功率:</label>
			<span class='rightcolumn'>
		...
		<div id="mac_enabled_container">
			<label class="leftcolumn" for='mac_filter_enabled'>无线 MAC 过滤:</label>
		...
		<div id="mac_filter_container">
			...
			<div>
				<label class='leftcolumn' for='mac_filter_policy'>MAC过滤策略:</label>
			...
			<div class='rightcolumnonly'>
				<div>
					...
					<input type="button" class="default_button" id="add_mac_button" value="添加" onclick="addMacToFilter()" />
				</div>
			</div>
		...
		<div id='wifi_list_ssid2_container'>
			<label class='leftcolumn' for='wifi_list_ssid2' id='wifi_list_ssid2_label'>SSID 加入:</label>
			<span class="rightcolumn">
		...
		<div id='wifi_client_band_container' class='indent'>
			<label class='leftcolumn' for='wifi_client_band' id='wifi_client_band_label'>无线绑定:</label>
		...
		<div id='wifi_channel2_container' class='indent'>
			<label class='leftcolumn' for='wifi_channel2' id='wifi_channel2_label'>无线频道:</label>
		...
		<div id='wifi_fixed_channel2_container' class='indent'>
			<label class='leftcolumn' for='wifi_fixed_channel2' id='wifi_fixed_channel2_label'>无线频道:</label>
			<span class='rightcolumn' id='wifi_fixed_channel2'>&nbsp;</span>
		</div>
		<div id='wifi_channel2_5ghz_container' class='indent'>
			<label class='leftcolumn' for='wifi_channel2_5ghz' id='wifi_channel2_5ghz_label'>无线频道:</label>
		...
		<div id='wifi_encryption2_container' class='indent'>
			<label class='leftcolumn' for='wifi_encryption2' id='wifi_encryption2_label'>加密:</label>
		...
		<div id='wifi_fixed_encryption2_container' class='indent'>
			<label class='leftcolumn' for='wifi_fixed_encryption2' id='wifi_fixed_encryption2_label'>加密:</label>
			<span class='rightcolumn' id='wifi_fixed_encryption2'>&nbsp;</span>
		</div>
		<div id='wifi_pass2_container' class='indent'>
			<label class='leftcolumn' for='wifi_pass2' id='wifi_pass2_label'>密码:</label>
		...
		<div id='wifi_wep2_container' class='indent'>
			<div style="display:block;">
				<label class='leftcolumn' for='wifi_wep2' id='wifi_wep2_label'>WEP 密钥:</label>
		...
		<div id='wifi_ssid1_container'>
			<label class='leftcolumn' for='wifi_ssid1' id='wifi_ssid1_label'>接入点 SSID:</label>
		...
		<div id='wifi_channel1_container' class='indent'>
			<label class='leftcolumn' for='wifi_channel1' id='wifi_channel1_label'>无线频道:</label>
		...
		<div id='wifi_fixed_channel1_container' class='indent'>
			<label class='leftcolumn' for='wifi_fixed_channel1' id='wifi_fixed_channel1_label'>无线频道:</label>
			<span class='rightcolumn' id='wifi_fixed_channel1'>&nbsp;</span>
		</div>

		<div id='wifi_channel1_5ghz_container' class='indent'>
			<label class='leftcolumn' for='wifi_channel1_5ghz' id='wifi_channel1_5ghz_label'>无线频道 (5GHz):</label>
		...
		<div id='wifi_encryption1_container' class='indent'>
			<label class='leftcolumn' for='wifi_encryption1' id='wifi_encryption1_label'>加密:</label>
		...
		<div id='wifi_pass1_container' class='indent'>
			<label class='leftcolumn' for='wifi_pass1' id='wifi_pass1_label'>密码:</label>
		...
		<div id='wifi_wep1_container' class='indent'>
			<div style="display:block;">
				<label class='leftcolumn' for='wifi_wep1' id='wifi_wep1_label'>WEP 密钥:</label>
		...
		<div id='wifi_server1_container' class='indent'>
			<label class='leftcolumn' for='wifi_server1' id='wifi_server1_label'>RADIUS 服务器 IP:</label>
			<input type='text' id='wifi_server1'  size='20' onkeyup='proofreadIP(this)'/><br/>
		</div>
		<div id='wifi_port1_container' class='indent'>
			<label class='leftcolumn' for='wifi_port1' id='wifi_port1_label'>RADIUS 服务器端口:</label>
		...
		<div id='wifi_hidden_container' class='indent'>
			<label class='leftcolumn' id='wifi_hidden_label' for='wifi_hidden'>广播 SSID:</label>
		...
		<div id='wifi_isolate_container' class='indent'>
			<label class='leftcolumn' id='wifi_isolate_label' for='wifi_isolate'>无线客户端隔离:</label>
		...
		<div id='wifi_mac_container' class="indent">
			<label class='leftcolumn' id='wifi_mac_label'><em>这个</em> 设备的 MAC:</label>
			<span class='rightcolumn' id='wifi_mac'> </span>
		</div>
		<div id="wifi_wds_container" class="indent">
			<label class='leftcolumn' for='wifi_wds_label' id='wifi_wds_label'><em>其他</em> WDS MAC 地址:</label>
			<span class='rightcolumn'>
				<input type='text' id='add_wifi_wds_mac' onkeyup='proofreadMac(this)' size='20' maxlength='17' />
				<input type="button" class="default_button" id="add_wifi_wds_mac_button" value="添加" onclick='addMacToWds("wifi")' />
			</span>
